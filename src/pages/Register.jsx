...
export const Register = () => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log(`Création de compte : ${form.fullName}`);
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-subtitle">Tous les champs sont requis</p>
        ...
        <div className="auth-footer">
          <p className="auth-footer-question">Déjà client(e) ?</p>
      ...
      <p className="auth-legal">
        ...
        <a href="#">conditions d'utilisation et de vente</a> d'Amazon. Consultez
        notre <a href="#">déclaration de confidentialité</a>, notre{" "}
        <a href="#">politique relative aux cookies</a> et notre{" "}
        <a href="#">
          politique relative à la publicité ciblée sur les centres d'intérêt
        </a>
        .
      </p>
    </div>
